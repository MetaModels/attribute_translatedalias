 ...
 *
 * @covers \MetaModels\AttributeTranslatedAliasBundle\DeprecatedAutoloader
 */
class DeprecatedAutoloaderTest extends TestCase
{
    ...
    {
        $this->assertTrue(\class_exists($oldClass), \sprintf('Class TranslatedAlias "%s" is not found.', $oldClass));
